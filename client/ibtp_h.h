...
extern int BTREE_PAGE_SIZE; //page size

extern const int BTYPE_OFFSET; //size of type of node cell
extern const int NKEYS_OFFSET; //size of number of keys cell
extern const int POINTERS_OFFSET; //offset of list of pointers
//extern const int HEADER; //calculate like sum of type of node cell size and number of keys cell size

extern const int KLEN_OFFSET; //size of key length cell
extern const int VLEN_OFFSET; //size of value length cell
extern const int KV_OFFSET; //KAY-VALUE list of pairs offset
extern const int BTREE_MAX_KEY_SIZE; //limitation for key size
extern const int BTREE_MAX_VAL_SIZE; //limitation for value size
