...
key* ibtp_get_key(btnode* node, UINT16 idx, unsigned char replicate); //get key by index
value* ibtp_get_val(btnode* node, UINT16 idx, unsigned char replicate); //get value by index
